...
<div class="checkout p-4">
    <div class="row">
        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <a href="<?php echo base_url('customer/products/'); ?>" class="btn btn-block btn-info">Add Items</a>
        </div>
        <div class="col-md-8 order-md-1">
            ...
            <form method="post">
                ...
                {
                ?>                
                <option value="<?php echo $loc->loc_name; ?>" <?php if($loc->loc_name == !empty($custData['location'])) echo 'selected="selected"'; ?>><?php echo $loc->loc_name;?></option>
                <?php
                }
                ?>
                </select>
                ...
                <div class="mb-3">
                    <label for="">Payment mode: Cash on delivery</label>
