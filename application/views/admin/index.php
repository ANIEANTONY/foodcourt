                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            ...
                            <div class="bg-cyan p-10 text-white text-center">
                                                   ...
                                                   <h5 class="m-b-0 m-t-5"><?php echo @$totalusers; ?></h5>
                    ...
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        <div class="card card-hover">
                            ...
                            <div class="bg-success p-10 text-white text-center">
                                                   <i class="fa fa-user m-b-5 font-16"></i>
                                                   <h5 class="m-b-0 m-t-5"><?php echo @$totalorders; ?></h5>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            ...
                            <div class="bg-warning p-10 text-white text-center">
                                                   <i class="fa fa-user m-b-5 font-16"></i>
                                                   <h5 class="m-b-0 m-t-5"><?php echo @$totalproducts; ?></h5>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            ...
                            <div class="bg-danger p-10 text-white text-center">
                                                   <i class="fa fa-user m-b-5 font-16"></i>
                                                   <h5 class="m-b-0 m-t-5"><?php echo @$monthorder; ?></h5>
                                                   <small class="font-light">Current Month orders</small>
                                                </div>
                        </div>
                    </div>
                    <!-- Column -->
