...
class Product extends CI_Model{
    ...
    function __construct() {
        ...
        $this->userordItemsTable = 'user_order_items';
    }
    ...
    /*
     * Insert user order items data in the database
     * @param data array
     */
    public function insertUserOrderItems($data = array()) {
        
        // Insert order items
        $insert = $this->db->insert_batch($this->userordItemsTable, $data);
    ...
    function getCategoryProduct($cat)
    {
